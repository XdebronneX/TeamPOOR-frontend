...
//                     </FormControl>
//                     <FormControl mb={4}>
//                         <FormLabel htmlFor="product_field">Product</FormLabel>
//                         <Select
//                             id="product_field"
...
//                                     ]); // Add selected product to productInfo with quantity initialized to 1
//                                 }
//                             }}
//                         >
...
//                         <Box key={product._id} bg="gray.100" p={2} mb={2} borderRadius={8} display="inline-block" mr={2}>
//                             <h2>{product.name} ({product.brand.name})</h2>
//                             <FormControl mb={2}>
//                                 <FormLabel htmlFor={`price_${product._id}_field`}>Price</FormLabel>
//                                 <Input
//                                     type="number"
//                                     id={`price_${product._id}_field`}
//                                     value={product.price || ''}
//                                     onChange={(e) => handleProductChange(product._id, 'price', e.target.value)}
//                                 />
//                             </FormControl>
//                             <FormControl mb={2}>
//                                 <FormLabel htmlFor={`quantity_${product._id}_field`}>Quantity</FormLabel>
//                                 <Input
//                                     type="number"
//                                     id={`quantity_${product._id}_field`}
