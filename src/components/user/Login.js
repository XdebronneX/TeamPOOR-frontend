...
import Loader from '../layout/Loader';
import {
    Button, Flex, Text, FormControl, FormLabel, FormErrorMessage,
    Heading, Stack, Image, Link, Box, useColorModeValue, Input
} from '@chakra-ui/react';
...
const Login = () => {
    ...
    useEffect(() => {
        if (isAuthenticated) {
            const successMessage = redirect === 'shipping' || redirect === 'booking' ?
    ...
    }, [dispatch, isAuthenticated, error, navigate, redirect, buttonClicked, handleSuccess, handleError]);
