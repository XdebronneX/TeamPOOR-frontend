...
import { Box, Container, Text, Grid, Button, Avatar, Divider, Stack, Input, Heading } from "@chakra-ui/react";
    ...
    return (
        <Fragment>
            {loading ? (
                ...
                <Container maxW="xl">
                    <Stack spacing={8} py={8} px={4} rounded="md" bg="white" boxShadow="md" position="relative">
                        ...
                        <Divider my={4} />
                        <Stack spacing={4}>
                            <Button variant="solid" colorScheme="teal" onClick={UpdateProfileHandler}>
                                Update Information
                            </Button>
                            <Button variant="outline" onClick={ChangePasswordHandler}>
                                Change Password
                            </Button>
                            {user && user.role === "user" && (
                                <Button variant="text" onClick={handleMotorcycle}>
                                    Register Motorcycle
                                </Button>
                            )}
                        </Stack>
