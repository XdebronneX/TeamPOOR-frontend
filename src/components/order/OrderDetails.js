...
//     const { success: isSuccess, checkoutUrl } = useSelector((state) => state.oldOrders);
...
//                                                     <p>
//                                                         <b>
//                                                             ₱ {(item.quantity * item.product?.price).toLocaleString(undefined, { minimumFractionDigits: 2 })}
//                                                         </b>
//                                                     </p>
//                                                 </div>
...
//                                     <p className="">
//                                         Grand Total: <b>₱ {totalPrice?.toLocaleString(undefined, { minimumFractionDigits: 2 })}</b>
//                                     </p>
...
//                                             ) : status.status === "TOSHIP" ? (
//                                                 <p className="font-semibold">Packed and Ready To Ship</p>
//                                             ) : status.status === "TORECEIVED" ? (
...
//                                                 ""
//                                             )}
//                                             <p className="text-zinc-500">{formatTimestamp(status.timestamp)}</p>
...
//                     <Button colorScheme="green" mr={3} onClick={continueHandler}
//                         style={{ display: latestStatus === "TOPAY" ? "inline-block" : "none" }}>
//                         Pay now
//                     </Button>
//                     {(latestStatus === "PENDING" || latestStatus === "TOPAY") && (
//                         <Button colorScheme="red" mr={3} onClick={cancelOrderHandler}>
//                             Cancel order
//                         </Button>
//                     )}
//                 </div>
...
//                                         <p className="font-bold">{selectedItemForReview.product.name}</p>
//                                         <img src={selectedItemForReview.product.images[0].url}
