...
const Header = () => {
  ...
  return (
    <Box className="flex bg-white shadow-sm sm:px-20 px-5">
      ...
      <div className="flex flex-1 items-center">
        ...
        <div className="flex flex-1 h-16 justify-between items-center space-x-4 p-3 ">
          ...
          <Box className="flex flex-row space-x-5 items-center">
            ...
            <Flex alignItems="center">
              <Stack direction="row" spacing={7} alignItems="center">
                {/* Render user menu or login button based on authentication status */}
                {user ? (
                  <Menu>
                    {/* User menu button */}
                    <MenuButton colorScheme="pink">
                    ...
                    <MenuList>
                      {/* User profile and role-based menu options */}
                      {/* Profile, Dashboard, My Motorcycles, etc. */}
                    </MenuList>
                  </Menu>
                ) : (
      ...
      {/* Modal for notification of new orders */}
      <Modal isOpen={showModal} onClose={handleCloseModal}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Notification for orders</ModalHeader>
