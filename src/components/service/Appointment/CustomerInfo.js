...
//         const selectedMotorcycleDetails = userMotorcycles.find(motorcycle => motorcycle._id === selectedMotorcycle);

//         // Extract necessary details from the selected motorcycle
//         const { model, brand, year, plateNumber, engineNumber, type } = selectedMotorcycleDetails;
...
//         const regionName = regionResponse.find(region => region.region_code === regionCode)?.region_name
//         const provinceName = provinceResponse.find(province => province.province_code === provinceCode)?.province_name
//         const cityName = cityResponse.find(city => city.city_code === cityCode)?.city_name
//         const barangayName = barangayResponse.find(barangay => barangay.brgy_code === address.barangay)?.brgy_name
...
//         dispatch(saveCustomerInfo({ fullname, phone, address: addressInfo, model, brand, year, plateNumber, engineNumber, type }));
...
//                         />
//                     </FormControl>
//                     <FormControl id="motorcycle_field" mb={4} isRequired>
//                         <FormLabel>Motorcycle</FormLabel>
//                         <div className="mb-3">
//                             <label htmlFor="motorcycle">Select Motorcycle:</label>
//                             <select id="motorcycle" className="form-select" value={selectedMotorcycle} onChange={handleMotorcycleChange}>
//                                 <option value="">Select Motorcycle</option>
//                                 {userMotorcycles && userMotorcycles.map(motorcycle => (
//                                     <option key={motorcycle._id} value={motorcycle._id}>{motorcycle.model} - {motorcycle.plateNumber} -</option>
//                                 ))}
//                             </select>
//                         </div>
//                     </FormControl>
